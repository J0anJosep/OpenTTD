...
const uint mask_industries = 1 << LT_INDUSTRYTYPE |
				1 << LT_TOWNS |
				1 << LT_CARGO |
				1 << LT_CARGO_ACCEPTANCE |
				1 << LT_INDUSTRY_PROPERTIES;
...
static const NWidgetPart _nested_industries_filter_widgets[] = {
	...
	NWidget(NWID_HORIZONTAL),
		...
		NWidget(WWT_PUSHTXTBTN, COLOUR_BROWN, FW_WIDGET_INDUSTRYTYPE), SetMinimalSize(96, 12),
				SetDataTip(STR_FILTER_TAB_INDUSTRYTYPES, STR_FILTER_TAB_INDUSTRYTYPES_TOOLTIP), SetFill(1, 0), SetResize(1, 0),
		...
		NWidget(WWT_PUSHTXTBTN, COLOUR_BROWN, FW_WIDGET_INDUSTRY_PROPERTIES), SetMinimalSize(96, 12),
				SetDataTip(STR_FILTER_TAB_INDUSTRY_PROPERTIES, STR_FILTER_TAB_INDUSTRY_PROPERTIES_TOOLTIP), SetFill(1, 0), SetResize(1, 0),
