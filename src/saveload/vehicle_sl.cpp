...
const SaveLoad *GetVehicleDescription(VehicleType vt)
{
	...
	static const SaveLoad _roadveh_desc[] = {
		...
		SLE_VEH_INCLUDE(),
		 SLE_CONDVAR(RoadVehicle, wait_counter,         SLE_UINT16,        SL_STUCK_SHIPS, SL_MAX_VERSION),
	...
	static const SaveLoad _ship_desc[] = {
		...
		SLE_VEH_INCLUDE(),
		 ...
		 SLE_CONDVAR(Ship, stuck,                     SLE_BOOL,        SL_STUCK_SHIPS, SL_MAX_VERSION),
		 SLE_CONDVAR(Ship, wait_counter,            SLE_UINT16,        SL_STUCK_SHIPS, SL_MAX_VERSION),
		 SLE_CONDVAR(Ship, lock,                     SLE_UINT8,         SL_LOCK_STATE, SL_MAX_VERSION),
	...
	static const SaveLoad _aircraft_desc[] = {
		...
		SLE_VEH_INCLUDE(),
		 ...
		 SLE_CONDVAR(Aircraft, desired_trackdir,      SLE_UINT8,      SL_RESET_AIRCRAFT, SL_MAX_VERSION),
