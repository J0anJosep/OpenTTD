...
static const SaveLoad _station_desc[] = {
	...
	SLE_ST_INCLUDE(),
	  ...
	  SLE_CONDVAR(Station, dock_station.tile,          SLE_UINT32,                  0, SL_MULTIPLE_DOCKS - 1),
	  SLE_CONDREF(Station, docks,                      REF_DOCKS,   SL_MULTIPLE_DOCKS, SL_MAX_VERSION),
	 ...
	 SLE_CONDNULL(                                     1,                         145, SL_RESET_AIRCRAFT - 1), // Airport rotation
	  SLE_CONDVAR(Station, airport.depot_id,           SLE_UINT16,                  SL_USE_DEPOT_IDS, SL_MAX_VERSION),
