...
static const SaveLoad _station_desc[] = {
	...
	SLE_ST_INCLUDE(),
	  ...
	  SLE_CONDVAR(Station, dock_station.tile,          SLE_UINT32,     SL_MIN_VERSION, SLV_MULTIPLE_DOCKS),
	  SLE_CONDREF(Station, docks,                      REF_DOCKS,  SLV_MULTIPLE_DOCKS, SL_MAX_VERSION),
	  ...
	  SLE_CONDVAR(Station, airport.depot_id,           SLE_UINT16,                 SLV_USE_DEPOT_IDS, SL_MAX_VERSION),
