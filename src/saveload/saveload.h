...
enum SaveLoadVersions {
	...
	SL_CONVINIENCE_SAVEBUMP_27572,  // 27572 -> Fix:        Convenience savegame bump to distinguish 1.6 savegames from 1.5 savegames.
	SL_CONVINIENCE_SAVEBUMP_27778,  // 27778 -> Fix:        Convenience savegame bump for 1.7.x savegames (version 196).
