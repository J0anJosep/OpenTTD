...
void CcRailDepot(Commands cmd, const CommandCost &result, TileIndex start_tile, RailType rt, DiagDirection dir, bool adjacent, bool extended, DepotID join_to, TileIndex end_tile)
{
