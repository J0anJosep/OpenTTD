...
struct TileTranslation {
	...
	TileTranslation(AirType at, AirportTileType att, TrackBits trackbits, Direction runway_directions) :
			ground(at),
			tracks(true),
			type(att),
			terminal_type(HTT_INVALID),
...
static const TileTranslation _translation_country_0[] = {
	...
	TileTranslation(AIRTYPE_GRAVEL,		ATT_RUNWAY,		TRACK_BIT_CROSS | TRACK_BIT_LEFT,	DIR_NE			),
	TileTranslation(AIRTYPE_GRAVEL,		ATT_RUNWAY,		TRACK_BIT_ALL & ~TRACK_BIT_3WAY_SE,	DIR_NE			),
...
static const TileTranslation _translation_commuter_0[] = {
	...
	TileTranslation(AIRTYPE_ASPHALT,	ATT_RUNWAY,		TRACK_BIT_NONE,				DIR_NE			),
	TileTranslation(AIRTYPE_ASPHALT,	ATT_RUNWAY,		TRACK_BIT_NONE,				DIR_NE			),
	TileTranslation(AIRTYPE_ASPHALT,	ATT_RUNWAY,		TRACK_BIT_NONE,				DIR_NE			),
...
static const TileTranslation _translation_city_0[] = {
	...
	TileTranslation(AIRTYPE_ASPHALT,	ATT_RUNWAY,		TRACK_BIT_CROSS,			DIR_NE			),
	TileTranslation(AIRTYPE_ASPHALT,	ATT_RUNWAY,		TRACK_BIT_NONE,				DIR_NE			),
	TileTranslation(AIRTYPE_ASPHALT,	ATT_RUNWAY,		TRACK_BIT_CROSS,			DIR_NE			),
	TileTranslation(AIRTYPE_ASPHALT,	ATT_RUNWAY,		TRACK_BIT_X,				DIR_NE			),
...
static const TileTranslation _translation_metropolitan_0[] = {
	...
	TileTranslation(AIRTYPE_ASPHALT,	ATT_RUNWAY,		TRACK_BIT_LOWER | TRACK_BIT_Y,		DIR_NE			),
	TileTranslation(AIRTYPE_ASPHALT,	ATT_RUNWAY,		TRACK_BIT_UPPER,			DIR_NE			),
	TileTranslation(AIRTYPE_ASPHALT,	ATT_RUNWAY,		TRACK_BIT_LEFT,				DIR_NE			),
	TileTranslation(AIRTYPE_ASPHALT,	ATT_RUNWAY,		TRACK_BIT_CROSS,			DIR_NE			),
...
static const TileTranslation _translation_international_0[] = {
	...
	TileTranslation(AIRTYPE_ASPHALT,	ATT_RUNWAY,		TRACK_BIT_CROSS,			DIR_SW			),
	TileTranslation(AIRTYPE_ASPHALT,	ATT_RUNWAY,		TRACK_BIT_RIGHT,			DIR_SW			),
	TileTranslation(AIRTYPE_ASPHALT,	ATT_RUNWAY,		TRACK_BIT_NONE,				DIR_SW			),
	TileTranslation(AIRTYPE_ASPHALT,	ATT_RUNWAY,		TRACK_BIT_NONE,				DIR_SW			),
	TileTranslation(AIRTYPE_ASPHALT,	ATT_RUNWAY,		TRACK_BIT_NONE,				DIR_SW			),
