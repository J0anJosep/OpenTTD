...
static const SpriteID AIRTYPE_ICONS         = 11;
static const SpriteID AIRTYPE_CURSORS       = 11;
static const SpriteID AIRTYPE_TILES         = 107;
static const SpriteID AIRTYPE_SPRITES       = AIRTYPE_ICONS + AIRTYPE_CURSORS + AIRTYPE_TILES;
static const SpriteID SPR_AIRPORT_TYPE_GRAVEL = SPR_AIRPORTX_BASE;
...
static const SpriteID SPR_AIRPORTTILES_GRAVEL = SPR_AIRPORT_TYPE_GRAVEL + AIRTYPE_ICONS + AIRTYPE_CURSORS;
static const SpriteID SPR_AIRPORTTILES_ASPHALT = SPR_AIRPORT_TYPE_ASPHALT + AIRTYPE_ICONS + AIRTYPE_CURSORS;
static const SpriteID SPR_AIRPORTTILES_WATER  = SPR_AIRPORT_TYPE_WATER + AIRTYPE_ICONS + AIRTYPE_CURSORS;

static const uint16 AIRPORT_SPRITES_GROUND = 0;
static const uint16 AIRPORT_SPRITES_OFFSET_RUNWAYS = 5;
static const uint16 AIRPORT_SPRITES_OFFSET_RUNWAYS_START = 8;
static const uint16 AIRPORT_SPRITES_OFFSET_RUNWAYS_END = 16;
...
static const uint16 AIRPORTX_SPRITE_COUNT = AIRTYPE_SPRITES * 3;
...
static const SpriteID SPR_AIRPORT_PREVIEW_LARGE            = SPR_AIRPORT_PREVIEW_BASE + 1 * 4;
static const SpriteID SPR_AIRPORT_PREVIEW_HELIPORT         = SPR_AIRPORT_PREVIEW_BASE + 2 * 4;
static const SpriteID SPR_AIRPORT_PREVIEW_METROPOLITAN     = SPR_AIRPORT_PREVIEW_BASE + 3 * 4;
static const SpriteID SPR_AIRPORT_PREVIEW_INTERNATIONAL    = SPR_AIRPORT_PREVIEW_BASE + 4 * 4;
static const SpriteID SPR_AIRPORT_PREVIEW_COMMUTER         = SPR_AIRPORT_PREVIEW_BASE + 5 * 4;
static const SpriteID SPR_AIRPORT_PREVIEW_HELIDEPOT        = SPR_AIRPORT_PREVIEW_BASE + 6 * 4;
static const SpriteID SPR_AIRPORT_PREVIEW_INTERCONTINENTAL = SPR_AIRPORT_PREVIEW_BASE + 7 * 4;
static const SpriteID SPR_AIRPORT_PREVIEW_HELISTATION      = SPR_AIRPORT_PREVIEW_BASE + 8 * 4;
static const SpriteID SPR_AIRPORT_PREVIEW_COUNT            = 9 * 4;
