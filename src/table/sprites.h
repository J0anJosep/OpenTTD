...
static const SpriteID SPR_AIRTYPE_BASE = SPR_ROAD_WAYPOINTS_BASE + ROAD_WAYPOINTS_SPRITE_COUNT;
...
static const uint16_t AIRTYPE_SPRITE_COUNT = AIRTYPE_SPRITES * 3;
...
static const SpriteID SPR_NEWGRFS_BASE = SPR_AIRPORT_PREVIEW_BASE + SPR_AIRPORT_PREVIEW_COUNT;
