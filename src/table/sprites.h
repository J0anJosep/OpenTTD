...
static const SpriteID SPR_WATER_LOCK_X               = SPR_OPENTTD_BASE + 179;
static const SpriteID SPR_WATER_LOCK_Y               = SPR_OPENTTD_BASE + 180;

/* Sprites for lock gates. */
static const uint GATE_SEQUENCE_FRAMES = 8;
static const SpriteID SPR_WATER_LOCK_GATE_SW         = SPR_OPENTTD_BASE + 181;
static const SpriteID SPR_WATER_LOCK_GATE_SE         = SPR_OPENTTD_BASE + 182;
static const SpriteID SPR_WATER_LOCK_BACK_X          = SPR_OPENTTD_BASE + 183;
...
/* Airport types graphics. */
static const uint16 AIRPORT_SPRITES = 22;
static const SpriteID SPR_AIRPORT_TYPE_ASPHALT       = SPR_WATER_LOCK_GATE_NW + GATE_SEQUENCE_FRAMES;
static const SpriteID SPR_AIRPORT_TYPE_GRAVEL        = SPR_AIRPORT_TYPE_ASPHALT + AIRPORT_SPRITES;
static const SpriteID SPR_AIRPORT_TYPE_WATER         = SPR_AIRPORT_TYPE_GRAVEL + AIRPORT_SPRITES;

/** Extra graphic spritenumbers */
static const uint16 OPENTTD_SPRITE_COUNT = SPR_AIRPORT_TYPE_WATER + AIRPORT_SPRITES;
...
static const SpriteID SPR_AUTORAIL_DIR_EN = SPR_AUTORAIL_WATER + 10;
static const SpriteID SPR_AUTORAIL_DIR_WS = SPR_AUTORAIL_DIR_EN + 10;
static const uint16 AUTORAIL_SPRITE_COUNT = 85;
...
static const SpriteID SPR_AIRFIELD_NS_RW_B  = SPR_AIRPORTX_BASE + 15;
static const SpriteID SPR_AIRFIELD_NS_RW_M  = SPR_AIRPORTX_BASE + 16;
static const SpriteID SPR_AIRFIELD_NS_RW_E  = SPR_AIRPORTX_BASE + 17;
static const SpriteID SPR_AIRFIELD_R_CROSS  = SPR_AIRPORTX_BASE + 18;
static const SpriteID SPR_RUNWAY_CROSS      = SPR_AIRPORTX_BASE + 19;
static const uint16 AIRPORT_SPRITES_GROUND = 0;
static const uint16 AIRPORT_SPRITES_OFFSET_RUNWAYS = 5;
static const uint16 AIRPORT_SPRITES_OFFSET_RUNWAYS_START = 13;
static const uint16 AIRPORT_SPRITES_OFFSET_RUNWAYS_END = 8;
static const uint16 AIRPORT_SPRITES_OFFSET_RUNWAYS_DONT_ALLOW_LANDING = 4;
static const uint16 AIRPORT_SPRITES_OFFSET_HANGARS = 29;
static const uint16 AIRPORT_SPRITES_OFFSET_TERMINALS = 41;
static const uint16 AIRPORT_TILES_OFFSET_TERMINALS = 33;
static const uint16 AIRPORT_SPRITES_COUNT   = 43;
static const SpriteID SPR_GRAVEL_BASE       = SPR_AIRPORTX_BASE + 20;
static const SpriteID SPR_ASPHALT_BASE      = SPR_AIRPORTX_BASE + 20 + AIRPORT_SPRITES_COUNT;
static const SpriteID SPR_WATER_BASE        = SPR_AIRPORTX_BASE + 20 + 2 * AIRPORT_SPRITES_COUNT;



static const uint16 AIRPORTX_SPRITE_COUNT = 200;
...
static const SpriteID SPR_AIRPORT_PREVIEW_LARGE            = SPR_AIRPORT_PREVIEW_BASE + 4;
static const SpriteID SPR_AIRPORT_PREVIEW_HELIPORT         = SPR_AIRPORT_PREVIEW_BASE + 8;
static const SpriteID SPR_AIRPORT_PREVIEW_METROPOLITAN     = SPR_AIRPORT_PREVIEW_BASE + 12;
static const SpriteID SPR_AIRPORT_PREVIEW_INTERNATIONAL    = SPR_AIRPORT_PREVIEW_BASE + 16;
static const SpriteID SPR_AIRPORT_PREVIEW_COMMUTER         = SPR_AIRPORT_PREVIEW_BASE + 20;
static const SpriteID SPR_AIRPORT_PREVIEW_HELIDEPOT        = SPR_AIRPORT_PREVIEW_BASE + 24;
static const SpriteID SPR_AIRPORT_PREVIEW_INTERCONTINENTAL = SPR_AIRPORT_PREVIEW_BASE + 28;
static const SpriteID SPR_AIRPORT_PREVIEW_HELISTATION      = SPR_AIRPORT_PREVIEW_BASE + 32;
static const SpriteID SPR_AIRPORT_PREVIEW_COUNT            = 36;
