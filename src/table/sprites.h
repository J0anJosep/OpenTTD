...
static const SpriteID SPR_FILTER_ICON                = SPR_OPENTTD_BASE + 179;
static const SpriteID SPR_FILTER_GROUPS_ICON         = SPR_OPENTTD_BASE + 180;

static const SpriteID SPR_PREF_TRACKDIRS_ICON        = SPR_OPENTTD_BASE + 181;
static const SpriteID SPR_PREF_TRACKDIRS_CURSOR      = SPR_OPENTTD_BASE + 182;

static const SpriteID SPR_WATER_LOCK_X               = SPR_OPENTTD_BASE + 183;
static const SpriteID SPR_WATER_LOCK_Y               = SPR_OPENTTD_BASE + 184;

/* Sprites for lock gates. */
static const uint GATE_SEQUENCE_FRAMES = 8;
static const SpriteID SPR_WATER_LOCK_GATE_SW         = SPR_OPENTTD_BASE + 185;
static const SpriteID SPR_WATER_LOCK_GATE_SE         = SPR_OPENTTD_BASE + 186;
static const SpriteID SPR_WATER_LOCK_BACK_X          = SPR_OPENTTD_BASE + 187;
