...
enum StringControlCode {
	...
	SCC_FONT_TINY,                     ///< Switch to small font
	SCC_FONT_BIG,                      ///< Switch to large font
	...
	SCC_LESS_THAN        = SCC_SPRITE_START + 0x04,
	SCC_GREATER_THAN     = SCC_SPRITE_START + 0x05,
	SCC_UP_ARROW         = SCC_SPRITE_START + 0x02,
	SCC_DOWN_ARROW       = SCC_SPRITE_START + 0x01,
	SCC_CHECKMARK        = SCC_SPRITE_START + 0x28,
	SCC_RIGHT_ARROW      = SCC_SPRITE_START + 0x03,
	SCC_SUPERSCRIPT_M1   = SCC_SPRITE_START + 0xB9,
	SCC_SMALL_UP_ARROW   = SCC_SPRITE_START + 0x05,
	SCC_SMALL_DOWN_ARROW = SCC_SPRITE_START + 0x06,
