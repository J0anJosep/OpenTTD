...
struct BaseVehicleListWindow : public Window {
	...
	enum ActionDropdownItemGroups {
		...
		ADIG_END_NON_AUTOMATED,
		ADIG_BEGIN_AUTOMATED = ADIG_END_NON_AUTOMATED,
		ADIG_GROUP_AUTOMATED_DO_NOTHING = ADIG_BEGIN_AUTOMATED,
		ADIG_GROUP_AUTOMATED_BUILD_ORDERS_SIMPLE,
		ADIG_GROUP_AUTOMATED_BUILD_ORDERS_STATIONS,
		ADIG_GROUP_AUTOMATED_BUILD_CARGO,
		ADIG_GROUP_AUTOMATED_BUILD_1ST_ENGINE_CLASS_CARGO,
		ADIG_GROUP_AUTOMATED_BUILD_1ST_ENGINE,
		ADIG_GROUP_AUTOMATED_BUILD_CARGO_ORDERS,
		ADIG_END_AUTOMATED,
		ADIG_END = ADIG_END_AUTOMATED,
	};
