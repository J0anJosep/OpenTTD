...
struct DepotWindow : Window {
	...
	~DepotWindow()
	{
		...
		DeleteWindowById(GetWindowClassForVehicleType(this->type), VehicleListIdentifier(VL_DEPOT_LIST, this->type, this->owner, this->window_number).Pack(), false);
...
struct SelectDepotWindow : Window {
	...
	void OnMouseOver(Point pt, int widget) override
	{
		...
		uint dep_index = this->vscroll->GetScrolledRowFromWidget(pt.y, this, WID_JS_PANEL, WD_FRAMERECT_TOP);
