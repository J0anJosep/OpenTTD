...
uint32 AirTypeResolverObject::GetDebugID() const
{
 ...
 */
AirTypeResolverObject::AirTypeResolverObject(const AirtypeInfo *ati, TileIndex tile, TileContext context, AirTypeSpriteGroup rtsg, uint32 param1, uint32 param2)
