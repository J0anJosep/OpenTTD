 ...
 * @param ta The tiles of the station that have may changed.
...
void TriggerWatchedCargoCallbacks(Station *st)
{
	...
	const CustomBitMap *footprint = st->GetStationCatchmentFootprint();
 ...
 */
void FindStationsAroundTiles(const TileArea &location, const CustomBitMap *mask, StationList *stations)
{
	...
	TILE_AREA_LOOP(tile, ta) {
		...
		Station *st = Station::GetByTile(tile);
		if (st == NULL || stations->find(st) != stations->end()) continue;
