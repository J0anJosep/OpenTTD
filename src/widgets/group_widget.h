...
enum GroupListWidgets {
	...
	WID_GL_VEHICLE_SORT_BY_DROPDOWN, ///< Vehicle sorter dropdown.
	...
	WID_GL_MANAGE_GROUPS_DROPDOWN,   ///< Manage groups dropdown list.
...
enum GroupDetailsWindowWidgets {
	...
	GIW_WIDGET_DETAILS_LAT_BEGIN,
	GIW_WIDGET_DETAILS_GENERAL = GIW_WIDGET_DETAILS_LAT_BEGIN,
	...
	GIW_WIDGET_DETAILS_LAT_END,

	GIW_WIDGET_DETAILS,
	GIW_WIDGET_LIST,
	GIW_WIDGET_LIST_SCROLLBAR,
	GIW_WIDGET_ORDERLISTS_SORTER_DROPDOWN,
