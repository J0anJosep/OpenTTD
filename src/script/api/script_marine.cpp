...
/* static */ bool ScriptMarine::BuildWaterDepot(TileIndex tile, TileIndex front)
{
	...
	return ScriptObject::DoCommand(tile, (uint)(::TileX(front) == ::TileX(tile)) | (NEW_DEPOT << 16), 0, CMD_BUILD_SHIP_DEPOT);
}
...
/* static */ bool ScriptMarine::BuildLock(TileIndex tile)
{
	...
	return ScriptObject::DoCommand(tile, 3, 0, CMD_BUILD_LOCK);
}
