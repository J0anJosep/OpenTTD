...
public:
	...
	enum FilterWindowWidgets {
		...
		FW_WIDGET_INDUSTRYTYPE                       = ::FW_WIDGET_INDUSTRYTYPE,                       ///< Industry type tab
		...
		FW_WIDGET_INDUSTRY_PROPERTIES                = ::FW_WIDGET_INDUSTRY_PROPERTIES,                ///< Industry properties
	...
	enum GroupListWidgets {
		...
		WID_GL_FILTER_GROUPS                         = ::WID_GL_FILTER_GROUPS,                         ///< Open filter for groups.
		WID_GL_FILTER_VEHICLES                       = ::WID_GL_FILTER_VEHICLES,                       ///< Open filter for vehicles.
		WID_GL_GROUP_SORT_BY_ORDER                   = ::WID_GL_GROUP_SORT_BY_ORDER,                   ///< Order of group sorter.
		WID_GL_GROUP_SORT_BY_DROPDOWN                = ::WID_GL_GROUP_SORT_BY_DROPDOWN,                ///< Group sorter dropdown.
		WID_GL_VEHICLE_SORT_BY_ORDER                 = ::WID_GL_VEHICLE_SORT_BY_ORDER,                 ///< Order of vehicle sorter.
		WID_GL_VEHICLE_SORT_BY_DROPDOWN              = ::WID_GL_VEHICLE_SORT_BY_DROPDOWN,              ///< Vehicle sorter dropdown.
	...
	enum RailToolbarWidgets {
		...
		WID_RAT_BUILD_BIG_DEPOT                      = ::WID_RAT_BUILD_BIG_DEPOT,                      ///< Build a big depot.
	...
	enum GameOptionsWidgets {
		...
		WID_GO_TAB_GENERAL                           = ::WID_GO_TAB_GENERAL,
		WID_GO_TAB_GRAPHICS                          = ::WID_GO_TAB_GRAPHICS,
		WID_GO_TAB_SOUND                             = ::WID_GO_TAB_SOUND,
		WID_GO_TAB_MUSIC                             = ::WID_GO_TAB_MUSIC,
		WID_GO_TAB_FONTS                             = ::WID_GO_TAB_FONTS,
		WID_GO_TAB_END                               = ::WID_GO_TAB_END,

		WID_GO_SEL_PANEL_BEGIN                       = ::WID_GO_SEL_PANEL_BEGIN,                       ///< Panels.
	...
	enum StationListWidgets {
		...
		WID_STL_FILTER                               = ::WID_STL_FILTER,                               ///< Filter icon button.
	...
	enum ToolbarTabletWidgets {
		...
		WID_TT_CHAT                                  = ::WID_TT_CHAT,                                  ///< Click to open chat.
